...
for i in range(N):
    ...
    phis_current, Rs_current, Rs_inv_current, acc_phis[:,i] = phis_move(phis_current,phis_prop,min_phi,max_phi,alphas,betas,V,D,A_invVmmu1_current,Rs_current,Rs_inv_current)
